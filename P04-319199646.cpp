...
int main()
{
	...
	*/
	...
	glm::mat4 modelCabina(1.0); //Para guardar a la cabina
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//CREANDO LA CABINA DE LA GRÚA/ Cuerpo
		...
		color = glm::vec3(0.8235f, 0.4118f, 0.1176f);
		...
		glm::mat4 modelPuntaCola = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.0f, 0.5f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();

		model = modelPuntaCola;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));	
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.5f, 1.0f));
		color = glm::vec3(0.545f, 0.270f, 0.074f); // Color más claro para el muslo
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		...
		modelaux = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f));
		...
		modelaux = glm::translate(model, glm::vec3(0.0f, -3.0f, 0.0f));
	...
	//	modelaux = model;
	//	glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
	//	color = glm::vec3(0.894f, 0.0f, 0.486f);
	//	glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
	...
	//	//rueda 1
	//	model = modelaux;
	//	model = glm::translate(model, glm::vec3(0.5f, -0.5f, 0.65f));
	...
	//	//rueda 2
	//	model = glm::translate(modelaux, glm::vec3(0.5f, -0.5f, -0.65f));
	//	model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
