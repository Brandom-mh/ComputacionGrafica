...
int main()
{
	...
	pointLights[1] = PointLight(1.0f, 1.0f, 1.0f,   
		0.1f, 1.5f,                                 // intensidades
		0.0, 3.0f, 3.0f,                        // posición
		0.3f, 0.1f, 0.05f);                         // atenuación
	pointLightCount++;
	...
	//luz fija
	spotLights[1] = SpotLight(1.0f, 0.85f, 0.4f,
		1.0f, 2.0f,
		5.0f, 10.0f, 0.0f,
		0.0f, -5.0f, 0.0f,
		1.0f, 0.0f, 0.0f,
	...
	spotLights[2] = SpotLight(1.0f, 1.0f, 1.0f,
		...
		15.0f);
	spotLightCount++;
	spotLights[3] = spotLights[2];                // mismo preset para el otro faro
	spotLightCount++;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec4 faroDer_local(+50.0f, 20.0f, 110.0f, 1.0f);
		glm::vec4 faroIzq_local(-50.0f, 20.0f, 110.0f, 1.0f);
		glm::vec3 dir_local = glm::normalize(glm::vec3(0.0f, -0.15f, 1.0f));
		glm::vec3 dir_world = glm::normalize(glm::mat3(modelaux) * dir_local);
		spotLights[2].SetFlash(modelaux* faroDer_local, dir_world);
		spotLights[3].SetFlash(modelaux* faroIzq_local, dir_world);
		...
		//luz Helicopter
		glm::vec4 heli_local_posH = glm::vec4(0.0f, -0.5f, 0.0f, 1.0f); 
		glm::vec3 dir_localH = glm::vec3(0.0f, -1.0f, 0.0f);       
		glm::vec3 pos_world = glm::vec3(modelaux * heli_local_posH);
		glm::vec3 dir_worldH = glm::normalize(glm::mat3(modelaux) * dir_localH);
		spotLights[1].SetFlash(pos_world, dir_worldH);    
