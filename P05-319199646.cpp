...
Model Goddard_M;
Model Mandibula_M;
Model PataDelantera_M;
Model PataTrasera_M;
Model Gtr;
Model Cofre;
Model Llanta_Delantera;
Model Llanta_Trasera;
...
int main()
{
	...
	Goddard_M = Model();
	Goddard_M.LoadModel("Models/goddardSeparado.fbx");
	Mandibula_M = Model();
	Mandibula_M.LoadModel("Models/mandibula.fbx");
	PataDelantera_M = Model();
	PataDelantera_M.LoadModel("Models/pierna_Frontal.fbx");
	PataTrasera_M = Model();
	PataTrasera_M.LoadModel("Models/pierna_trasera.fbx");

	//#-----Instancia del Carro-----#//
	Gtr = Model();
	Gtr.LoadModel("Models/gtr.fbx");
	Cofre = Model();
	Cofre.LoadModel("Models/cofre.fbx");
	Llanta_Delantera = Model();
	Llanta_Delantera.LoadModel("Models/llanta_delantera.fbx");
	Llanta_Trasera = Model();
	Llanta_Trasera.LoadModel("Models/llanta_trasera.fbx");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		//Mandibula
		model = glm::translate(modelaux, glm::vec3(2.7f, 0.6f, 0.0f));
		...
		*/
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.3f, -0.5f, 0.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		PataDelantera_M.RenderModel();
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, -1.1f, 0.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		PataTrasera_M.RenderModel();
		...
		//------------*INICIA DIBUJO DEL GTR-------------------*
		//GTR desarmado
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getarticulacion11()));
		...
		//llanta traser derecha
		model = modelaux;
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.5f, 0.8f, 0.1f));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Llanta_Delantera.RenderModel();

		//llanta trasera izquierda
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.52f, 0.8f, 0.1f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.5f, -0.85f, 0.1f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.50f, -0.85f, 0.1f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//cofre
		model = modelaux;
		color = glm::vec3(0.3608f, 0.3333f, 0.3333f);
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, 0.49f));
