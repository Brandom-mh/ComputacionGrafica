...
int main()
{
	...
	caucho_FD = Model();
	caucho_FD.LoadModel("Models/caucho_FD.fbx");
	caucho_FI = Model();
	caucho_FI.LoadModel("Models/caucho_FI.fbx");
	caucho_TD = Model();
	caucho_TD.LoadModel("Models/caucho_TD.fbx");
	caucho_TI = Model();
	caucho_TI.LoadModel("Models/caucho_TI.fbx");
	rin_FD = Model();
	rin_FD.LoadModel("Models/rin_FD.fbx");
	rin_FI = Model();
	rin_FI.LoadModel("Models/rin_FI.fbx");
	rin_TD = Model();
	rin_TD.LoadModel("Models/rin_TD.fbx");
	rin_TI = Model();
	rin_TI.LoadModel("Models/rin_TI.fbx");
	cofre_M = Model();
